...
public class LdapRealmTest {
	...
	public void normal() {
		...
		assertThat(realm.getLoginPasswordAuthenticator()).isInstanceOf(
				LoginPasswordAuthenticator.class).isInstanceOf(
				LdapAuthenticator.class);
		assertThat(realm.getUsersProvider()).isInstanceOf(
				ExternalUsersProvider.class).isInstanceOf(
				LdapUsersProvider.class);
	...
	public void noConnection() {
		...
		assertThat(realm.getGroupsProvider()).isInstanceOf(
				ExternalGroupsProvider.class).isInstanceOf(
				LdapGroupsProvider.class);
