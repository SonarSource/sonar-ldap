...
public class AdConnectionHelperTest {
    ...
    public void getUserAttributeValueNormalTest() {
        ...
        assertThat(adConnectionHelper.getUserAttributeValue(fields, AdConnectionHelper.COMMON_NAME_ATTRIBUTE)).
                isEqualTo(fullName);

        assertThat(adConnectionHelper.getUserAttributeValue(fields, AdConnectionHelper.MAIL_ATTRIBUTE)).
                isEqualTo(mail);
    }
